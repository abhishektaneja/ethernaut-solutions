...
contract SwappableTokenTwo is ERC20 {
  ...
  constructor(address dexInstance) ERC20("token", "tkn") {
...
contract HackCoin is ERC20 {
  address private _dex;
  constructor(address dexInstance) ERC20("token222", "tkn2") {
...
contract Hack {
  ...
  function hack() public {
    // create a hack coin with 110 supply and a lot of coins to dex
    // approve dex instance  as spender 0xECE9061706E3614995599688564E05Faf2de7CbD,100000
    // Swap between coins to gain access to all coins
  }
}
